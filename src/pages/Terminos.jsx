    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 space-y-6 text-slate-700 text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">1. Aceptación de los términos</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">2. Elegibilidad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">3. Registro e identidad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">4. Conducta</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">5. Modificaciones</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">6. Limitación de responsabilidad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">7. Contacto</h2>
            <p>Para dudas sobre estos términos, contáctanos a través de la página de <a href="/contacto" className="text-blue-600 hover:underline">Contacto</a>.</p>
          </section>
        </div>
      </div>
    </div>
