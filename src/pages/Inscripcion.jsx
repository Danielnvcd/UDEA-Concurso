        ...
        >
          {loading ? (
            ...
            <div className="text-center p-12 bg-white rounded-xl shadow-sm border border-slate-200">
               ...
               <h3 className="text-2xl font-bold text-slate-900 mb-2">Inicio de Sesión Requerido</h3>
               <p className="text-slate-500 mb-8 max-w-sm mx-auto">Para inscribir a tu equipo en el concurso, necesitas iniciar sesión con tu cuenta de Google institucional o personal.</p>
               <button 
                 onClick={handleGoogleLogin} 
                 className="inline-flex items-center gap-3 px-6 py-3 bg-white border border-slate-300 rounded-lg text-slate-700 font-semibold hover:bg-slate-50 transition-colors shadow-sm"
               >
             ...
             <>
              <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between bg-blue-50 border border-blue-100 rounded-xl p-4 gap-4">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <p className="text-xs text-blue-600 font-bold uppercase tracking-wider">Sesión iniciada como:</p>
                 ...
                 <button 
                   ...
                   className="text-sm font-semibold text-slate-500 hover:text-slate-700 underline shrink-0"
                 >
                    Cerrar sesión
                 </button>
              </div>
              ...
              {checkingTeam ? (
                 ...
                 <div className="text-center p-8 sm:p-12 bg-white rounded-xl shadow-sm border border-slate-200">
                    <div className="w-16 h-16 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-6">
                       <CheckCircle2 className="w-8 h-8" />
                    </div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">Ya estás registrado</h3>
                    <p className="text-slate-500 mb-8 max-w-md mx-auto">
                      Tu correo <strong>{session.user.email}</strong> ya se encuentra vinculado a un equipo. No es necesario que vuelvas a llenar el formulario.
                    </p>
                    
                    <div className="bg-slate-50 rounded-xl p-6 mb-8 max-w-sm mx-auto border border-slate-200 text-left">
                       <div className="mb-4">
                          <p className="text-xs text-slate-500 uppercase font-bold tracking-wider mb-1">Folio del Equipo</p>
                          <p className="text-xl font-black text-blue-600">{existingTeam.folio}</p>
                       </div>
                       <div>
                          <p className="text-xs text-slate-500 uppercase font-bold tracking-wider mb-1">Nombre del Equipo</p>
                          <p className="font-semibold text-slate-900">{existingTeam.team_name}</p>
                       </div>
                    </div>
                 </div>
              ) : (
