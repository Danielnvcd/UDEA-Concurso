    ...
    <div className="min-h-screen bg-[#070b0a] pt-24 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl shadow-sm border border-white/10 p-8 space-y-6 text-slate-400 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-2">3. Compartición de datos</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-2">4. Seguridad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-2">5. Tus derechos</h2>
            <p>Puedes solicitar la eliminación de tus datos en cualquier momento contactando al equipo organizador del evento.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">6. Contacto</h2>
            <p>Para preguntas sobre esta política, contáctanos a través de la página de <a href="/contacto" className="text-blue-400 hover:underline">Contacto</a>.</p>
          </section>
        </div>
      </div>
    </div>
