    ...
    <footer className="bg-black text-white border-t border-white/[0.06] relative z-10" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="py-10 sm:py-14 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          ...
          {/* Navigation */}
          <div>
            <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/55 mb-5">Navegación</p>
          ...
          {/* Stack & créditos */}
          <div>
            <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/55 mb-5">Stack</p>
            <div className="flex flex-wrap gap-2 mb-5">
              {/* React */}
              <div className="glass-pill inline-flex items-center gap-2 px-3 py-2">
                <svg viewBox="0 0 24 24" className="w-4 h-4 text-white/85" fill="currentColor">
                ...
                <span className="text-xs font-medium text-white/80">React</span>
              </div>

              {/* Vite */}
              <div className="glass-pill inline-flex items-center gap-2 px-3 py-2">
                <svg viewBox="0 0 410 404" className="w-4 h-4" fill="none">
                ...
                <span className="text-xs font-medium text-white/80">Vite</span>
              </div>
              ...
              <div className="glass-pill inline-flex items-center gap-2 px-3 py-2">
                ...
                <span className="text-xs font-medium text-white/80">Tailwind</span>
              </div>

              {/* Framer Motion */}
              <div className="glass-pill inline-flex items-center gap-2 px-3 py-2">
                <svg viewBox="0 0 14 21" className="w-3.5 h-4 text-white/85" fill="currentColor">
            ...
            <div className="flex flex-col gap-2 items-start pt-5 border-t border-white/[0.06]">
              <a
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/[0.06] py-5 flex flex-col md:flex-row justify-between items-center gap-3 text-center safe-bottom">
          <p className="text-xs text-white/45">
            {new Date().getFullYear()} UDEA. Todos los derechos reservados.
          </p>
          <div className="flex items-center gap-4">
            <Link to="/privacidad" className="text-xs text-white/45 hover:text-white/80 transition-colors">
              Política de Privacidad
            </Link>
            <span className="text-white/20 text-xs">·</span>
            <Link to="/terminos" className="text-xs text-white/45 hover:text-white/80 transition-colors">
              Términos de Servicio
            </Link>
          </div>
          <p className="text-xs text-white/45">
            Diseñado y construido por <span className="text-white/80 font-medium">danielnvcd</span>
          </p>
        </div>
      </div>
    </footer>
